package cwp.njupt.com.weatherreport;
...
/*
    ...
    public void jsonToValue(String jsonData ,String jsonFlag){
        try {
            JSONObject json=new JSONObject(jsonData).getJSONObject(jsonFlag);
            cityName= (String) json.opt("city");
            cityId= (String) json.opt("cityid");
            currentTemp= (String) json.opt("temp");
            minTemp= (String) json.opt("temp2");
            maxTemp= (String) json.opt("temp1");
            weather= (String) json.opt("weather");
            humidity= (String) json.opt("SD");
            windDirection= (String) json.opt("WD");
            windScore= (String) json.opt("WS");
            updateTime= (String) json.opt("time");
        } catch (JSONException e) {
            Log.i("!","又他妈出错了！");
            e.printStackTrace();
        }
...
*/
    ...
    /*
    class getFromHttp extends AsyncTask<String, Void, String> {
